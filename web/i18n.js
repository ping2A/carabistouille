...
(function () {
  ...
  const translations = {
    ...
    'app.finishing': { en: 'Finishing…', fr: 'En cours…', zh: '结束中…' },
    ...
    'app.tabSession': { en: 'Session', fr: 'Session', zh: '会话' },
    'app.noSession': { en: 'No session events', fr: 'Aucun événement de session', zh: '无会话事件' },
    ...
    'admin.verdict': { en: 'Verdict', fr: 'Verdict', zh: '结论' },
    'admin.openInAnalyzer': { en: 'Open in Analyzer', fr: 'Ouvrir dans l’analyseur', zh: '在分析器中打开' },
    'admin.copied': { en: 'Copied!', fr: 'Copié !', zh: '已复制！' },
